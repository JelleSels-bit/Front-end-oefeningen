...
const getScores = (): Record<string, IHighscore[]> => {
    ...
    if (localStorage.scores) {
        scores = JSON.parse(localStorage.scores as string) as Record<string, IHighscore[]>
    } else {
